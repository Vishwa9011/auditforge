                ...
                <div className="flex h-full shrink-0 items-center px-2">
                    <div className="flex items-center gap-1.5">
                        <Button
                            ...
                            title={hasActiveFileUnsavedChanges ? 'Save' : 'No changes to save'}
                            aria-label="Save"
                        >
                            {isSavingActiveFile ? (
                        ...
                        <Button
                            ...
                            title={hasUnsavedChanges ? 'Save all' : 'No changes to save'}
                            aria-label="Save all"
                        >
                            {isSavingAllFiles ? (
                                <Loader2 className="size-3.5 animate-spin" />
                        ...
                        <Button
                            ...
                            title={activeFilePath ? 'Analyze' : 'Select a file to analyze'}
                            aria-label="Analyze"
