...
const categoryStyles: Record<Category, { label: string; className: string }> = {
    security: {
        label: 'Security',
        className:
            'border-purple-200 bg-purple-50 text-purple-800 dark:border-purple-900 dark:bg-purple-950 dark:text-purple-200',
    },
    gas: {
        label: 'Gas',
    ...
    style: {
        label: 'Style',
        className: 'border-zinc-200 bg-zinc-50 text-zinc-800 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-200',
    },
};
...
export function CategoryBadge({ category, className }: { category: Category; className?: string }) {
    ...
    return (
        <Badge variant="outline" className={cn('border', c.className, className)}>
            {c.label}
        </Badge>
    );
}
