    ...
    return (
        <div className="flex h-full min-h-0 flex-col">
            <div className="border-border/60 bg-background sticky top-0 z-10 flex h-10 items-center justify-between border-b px-3 py-2">
                <h2 className="text-muted-foreground text-xs font-semibold tracking-wide whitespace-nowrap uppercase">
                    File Explorer
                </h2>
    ...
    return (
        <div className="flex h-full min-h-0 flex-col gap-4">
            <div className="border-border/60 bg-background flex h-10 items-center border-b px-3 py-2">
                <h2 className="text-muted-foreground align-middle text-xs font-semibold tracking-wide whitespace-nowrap uppercase">
                    File Explorer
                </h2>
            </div>
